    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        let mut extras_args = match self {
            ...
            Command::Move(mode, amount) => match (mode, amount) {
                ...
                (MoveMode::Up, MoveAmount::HalfPage) => vec!["upwards".to_string()],
                (MoveMode::Down, MoveAmount::HalfPage) => vec!["downwards".to_string()],
                (MoveMode::Left, MoveAmount::HalfPage) => vec!["leftwards".to_string()],
                (MoveMode::Right, MoveAmount::HalfPage) => vec!["rightwards".to_string()],
                (MoveMode::Up, MoveAmount::FullPage) => vec!["pageup".to_string()],
                (MoveMode::Down, MoveAmount::FullPage) => vec!["pagedown".to_string()],
                (MoveMode::Left, MoveAmount::FullPage) => vec!["pageleft".to_string()],
                (MoveMode::Right, MoveAmount::FullPage) => vec!["pageright".to_string()],
